...
namespace Toon
{
	/****************************************************************************
			...
			code or tables extracted from it, as desired without restriction.
						...
						CRC32 Hash related table and method are at below.
	****************************************************************************/
	
	constexpr std::array<unsigned long, 256> crc32Table{ /* CRC polynomial 0xedb88320 */
	...
	****************************************************************************/
	...
	{
	private:
		static constexpr unsigned long UPDC32(char octet, unsigned long crc);
	public:
